...
@NgModule({
  ...
  exports:[ MatButtonModule,SidebarComponent,NavbarComponent,HomeComponent,MatDividerModule, MatIconModule,MatSidenavModule,HttpClientModule,ReactiveFormsModule,MatDialogModule,FormsModule
  ]
})
